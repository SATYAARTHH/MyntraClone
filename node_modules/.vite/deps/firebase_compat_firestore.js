...
var Blob = class {
  ...
  static fromBase64String(base64) {
    ...
    return new Blob(Qc2.fromBase64String(base64));
  }
  static fromUint8Array(array) {
    assertUint8ArrayAvailable();
    return new Blob(Qc2.fromUint8Array(array));
  }
  toBase64() {
    assertBase64Available();
...
var IndexedDbPersistenceProvider = class {
  enableIndexedDbPersistence(firestore, forceOwnership) {
    return xc2(firestore._delegate, { forceOwnership });
  }
  enableMultiTabIndexedDbPersistence(firestore) {
    return Nc2(firestore._delegate);
  }
  clearIndexedDbPersistence(firestore) {
    return Mc2(firestore._delegate);
  }
};
var Firestore = class {
  ...
  useEmulator(host, port, options = {}) {
    _c(this._delegate, host, port, options);
  }
  enableNetwork() {
  ...
  enablePersistence(settings) {
    ...
    if (settings) {
      ...
      oc2("synchronizeTabs", synchronizeTabs, "experimentalForceOwningTab", experimentalForceOwningTab);
    }
  ...
  collection(pathString) {
    try {
      return new CollectionReference(this, yc2(this._delegate, pathString));
    } catch (e) {
  ...
  doc(pathString) {
    try {
      return new DocumentReference(this, Ic2(this._delegate, pathString));
    } catch (e) {
  ...
  loadBundle(bundleData) {
    return Lc2(this._delegate, bundleData);
  }
  namedQuery(name2) {
    return Uc2(this._delegate, name2).then((expQuery) => {
      if (!expQuery) {
        return null;
      }
...
var Transaction = class {
  ...
  get(documentRef) {
    ...
    return this._delegate.get(ref).then((result) => new DocumentSnapshot(this._firestore, new Rh(this._firestore._delegate, this._userDataWriter, result._key, result._document, result.metadata, ref.converter)));
  }
...
var DocumentReference = class {
  ...
  static forPath(path, firestore, converter) {
    ...
    return new DocumentReference(firestore, new wc2(firestore._delegate, converter, new xt(path)));
  }
  static forKey(key, firestore, converter) {
    return new DocumentReference(firestore, new wc2(firestore._delegate, converter, key));
  }
  get id() {
  ...
  collection(pathString) {
    try {
      return new CollectionReference(this.firestore, yc2(this._delegate, pathString));
    } catch (e) {
  ...
  isEqual(other) {
    ...
    if (!(other instanceof wc2)) {
      return false;
    }
    return Tc2(this._delegate, other);
  }
  set(value, options) {
  ...
  onSnapshot(...args) {
    ...
    const observer = wrapObserver(args, (result) => new DocumentSnapshot(this.firestore, new Rh(this.firestore._delegate, this._userDataWriter, result._key, result._document, result.metadata, this._delegate.converter)));
  ...
  get(options) {
    ...
    return snap.then((result) => new DocumentSnapshot(this.firestore, new Rh(this.firestore._delegate, this._userDataWriter, result._key, result._document, result.metadata, this._delegate.converter)));
  }
...
var DocumentSnapshot = class {
  ...
  isEqual(other) {
    return vh(this._delegate, other._delegate);
  }
};
...
var Query = class {
  ...
  where(fieldPath, opStr, value) {
    try {
      return new Query(this.firestore, Ch(this._delegate, Nh(fieldPath, opStr, value)));
    } catch (e) {
  ...
  orderBy(fieldPath, directionStr) {
    try {
      return new Query(this.firestore, Ch(this._delegate, Mh(fieldPath, directionStr)));
    } catch (e) {
      throw replaceFunctionName(e, /(orderBy|where)\(\)/, "Query.$1()");
    }
  }
  limit(n) {
    try {
      return new Query(this.firestore, Ch(this._delegate, Fh(n)));
    } catch (e) {
  ...
  limitToLast(n) {
    try {
      return new Query(this.firestore, Ch(this._delegate, $h(n)));
    } catch (e) {
  ...
  startAt(...args) {
    try {
      return new Query(this.firestore, Ch(this._delegate, Lh(...args)));
    } catch (e) {
  ...
  startAfter(...args) {
    try {
      return new Query(this.firestore, Ch(this._delegate, Uh(...args)));
    } catch (e) {
  ...
  endBefore(...args) {
    try {
      return new Query(this.firestore, Ch(this._delegate, Kh(...args)));
    } catch (e) {
  ...
  endAt(...args) {
    try {
      return new Query(this.firestore, Ch(this._delegate, Gh(...args)));
    } catch (e) {
  ...
  get(options) {
    ...
    return query.then((result) => new QuerySnapshot(this.firestore, new Ph(this.firestore._delegate, this._userDataWriter, this._delegate, result._snapshot)));
  }
  onSnapshot(...args) {
    const options = extractSnapshotOptions(args);
    const observer = wrapObserver(args, (snap) => new QuerySnapshot(this.firestore, new Ph(this.firestore._delegate, this._userDataWriter, this._delegate, snap._snapshot)));
    return fl(this._delegate, options, observer);
  }
  withConverter(converter) {
...
var CollectionReference = class extends Query {
  ...
  doc(documentPath) {
    try {
      if (documentPath === void 0) {
        return new DocumentReference(this.firestore, Ic2(this._delegate));
      } else {
        return new DocumentReference(this.firestore, Ic2(this._delegate, documentPath));
      }
    } catch (e) {
  ...
  isEqual(other) {
    return Tc2(this._delegate, other._delegate);
  }
  withConverter(converter) {
...
function castReference(documentRef) {
  return hc2(documentRef, wc2);
}
var FieldPath = class {
  constructor(...fieldNames) {
    this._delegate = new Kc2(...fieldNames);
  }
  static documentId() {
